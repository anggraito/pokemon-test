...
import { BG_SET, DARKSLATE, Font16, Font20, ITEM_CENTER, SCREEN_HEIGHT, SHADOW_BOTTOM, WHITE } from '../../helpers/globalStyles'
import { normalize } from '../../helpers/scallingSize'

export default function DetailList({itemName}) {
  return (
    <View style={BG_SET}>
      <View style={{backgroundColor: WHITE, ...SHADOW_BOTTOM, ...ITEM_CENTER, height: SCREEN_HEIGHT/3}}>
        ...
        <Text style={{fontSize: 24, color: DARKSLATE, paddingTop: 10}}>{itemName}</Text>
